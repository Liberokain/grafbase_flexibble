...
const ProjectForm = ({ type, session, project }: Props) => {
    ...
    const [form, setForm] = useState<FormState>({
        title: project?.title || "teste",
        description: project?.description || "teste",
        image: project?.image || "",
        liveSiteUrl: project?.liveSiteUrl || "https://linosoft.com.br",
        githubUrl: project?.githubUrl || "https://linosoft.com.br",
